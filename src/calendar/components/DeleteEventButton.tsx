...
export const DeleteEventButton = ()=>{
    ...
    <button onClick={()=>{
        startDeletingEvent()
    }} type="button" className={`${visibility} w-16 h-16 flex justify-center items-center text-white absolute left-4 bottom-4 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2.5 text-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800`}>
